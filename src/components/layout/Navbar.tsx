...
import { Search, Plus, Menu, X, BarChart2 } from 'lucide-react'; // Added BarChart2 import
        ...
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center">
            ...
            <div className="hidden md:ml-6 md:flex md:space-x-8">
              ...
              <Link 
                to="/analytics" 
                className={`${path === '/analytics' ? 'border-indigo-500 text-gray-900' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700'} inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium`}
              >
                Analytics {/* Added Analytics link */}
              </Link>
            </div>
          </div>
